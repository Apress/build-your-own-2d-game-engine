 ...
 *        // At this point shape of renderable1 is in the stencil buffer, we can choose to enable stencil testing
 *        
...
gEngine.Stencil = (function () {
    /**
     * Begins drawing to the stencil buffer. Assumes depth and frame buffer are both write enabled.
     * NOTE: Until the call to endDrawingToStencilBuffer(), everything drawn will go into the stencilBuffer
    ...
    var beginDrawToStencilBuffer  = function() {
        ...
        gl.stencilFunc(gl.ALWAYS, 1, 0xFF);  // Stencil ref of 1, so the ref=1, and Mask=0xff, are actually not used
        gl.stencilOp(gl.REPLACE, gl.REPLACE, gl.REPLACE); // Three actions for: StencilFail, DepthFail, and DepthPass 
    ...
    /**
     * Stops drawing to stencil buffer, from this point on renderable drawing will change colors in the framebuffer as usual.
    ...
    var beginStencilCulling = function() {
        ...
        gl.stencilOp(gl.KEEP, gl.KEEP, gl.KEEP); // Three actions for: StencilFail, DepthFail, and DepthPass 
    };
    
    /**
     * Ends stencil culling tes. It is assumed beginStencilCulling test has been called and this function terminates stencil culling.
     * @returns {void}
     */
