...
MyGame.prototype.hpUp = function() {
    this.UIHealth.incCurrentHP(10);
};

MyGame.prototype.hpDown = function(){
    this.UIHealth.incCurrentHP(-10);
};

MyGame.prototype.setToRed = function() {
    this.radarbox.setColor([1,0,0,1]);
};

MyGame.prototype.setToBlue = function() {
    this.radarbox.setColor([0,0,1,1]);
};

MyGame.prototype.setToGreen = function() {
    this.radarbox.setColor([0,1,0,1]);
};

MyGame.prototype.hpSelect = function(){
    this.demoSelect=1;
};

MyGame.prototype.textBoxSelect = function(){
    this.demoSelect=2;
};

MyGame.prototype.radarSelect = function(){
    this.demoSelect=3;
};

MyGame.prototype.allSelect = function(){
    this.demoSelect=4;
};

MyGame.prototype.UITextBoxTest = function(){
