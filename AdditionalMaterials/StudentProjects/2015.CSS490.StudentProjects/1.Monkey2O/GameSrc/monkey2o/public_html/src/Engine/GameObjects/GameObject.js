...
//------------------------------------------------------------------------------
GameObject.prototype.drawAsChild = function(aCamera, parentXform) {
  if(this.isVisible()) {
    this.mRenderComponent.drawAsChild(aCamera, parentXform);
  }
};
...
//------------------------------------------------------------------------------
GameObject.prototype.removeLight = function(light) {
  this.mRenderComponent.removeLight(light);
};

//------------------------------------------------------------------------------
GameObject.prototype.clearLights = function() {
  this.mRenderComponent.clearLights();
};
