...
gEngine.LayerManager = (function () {
    ...
    var initialize = function() {
        ...
        mAllLayers[gEngine.eLayer.eBananas] = new GameObjectSet();
        mAllLayers[gEngine.eLayer.eBubbles] = new GameObjectSet();
    ...
    var clearLayer = function(layerEnum) {
      mAllLayers[layerEnum] = new GameObjectSet();
    };
    
    var get = function(layerEnum, index) {
      return mAllLayers[layerEnum].getObjectAt(index);
    };
