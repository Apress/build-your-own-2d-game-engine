...
Camera.prototype.setupViewProjection = function () {
    ...
    // Step A3: set the color (if alpha is 0, don't draw anything)
    if (this.mBgColor[3] !== 0) {
    ...
    // Clear the color (if alpha is 0, don't draw anything)
    if (this.mBgColor[3] !== 0) {
...
Camera.prototype.getCameraShakeObject = function() {
