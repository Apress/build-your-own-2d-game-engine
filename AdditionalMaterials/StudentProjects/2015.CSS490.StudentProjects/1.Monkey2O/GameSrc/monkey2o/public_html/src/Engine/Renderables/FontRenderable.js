...
// Public methods
//**-----------------------------------------
FontRenderable.prototype.draw = function (aCamera, parentXform) {
  if(this.mIsVisible) {
    ...
    for (charIndex = 0; charIndex < this.mText.length; charIndex++) {
      ...
      if(parentXform) {
        this.mOneChar.drawAsChild(aCamera, parentXform);
      } else {
...
FontRenderable.prototype.drawAsChild = function(aCamera, parentXform) {
  FontRenderable.prototype.draw.call(this, aCamera, parentXform);
};
...
FontRenderable.prototype.setVisibility = function(isVisible) {
  this.mIsVisible = isVisible || false;
};
