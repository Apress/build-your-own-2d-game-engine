...
LightRenderable.prototype.drawAsChild = function (aCamera, xf) {
    this.mShader.setLights(this.mLights);
    SpriteAnimateRenderable.prototype.drawAsChild.call(this, aCamera, xf);
};
...
//may cause problems, mShader has not been updated to deal with null light indecies
LightRenderable.prototype.removeLightAt = function (index) {
    this.mLights[index] = null;
};
