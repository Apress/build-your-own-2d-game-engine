...
function TotemLight() {
    ...
    this.kTitle = "assets/TotemLight_Title.png";
...
gEngine.Core.inheritPrototype(TotemLight, Scene);

TotemLight.prototype.loadScene = function()
{
...
TotemLight.prototype.unloadScene = function()
{   
...
TotemLight.prototype.initialize = function () {
    ...
    for(i = 0; i < b.length; i++) {
        ...
        this.mAllTotems.getObjectAt(i).setButtonState(true);
    }
...
TotemLight.prototype.draw = function () {
...
TotemLight.prototype.update = function () {
