...
SceneFileParser.prototype.parsePlatform = function (texture, normal, lightSet) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        p = new Platform(x, y, v, r, texture, normal, lightSet, t);
...
SceneFileParser.prototype.parseMinions = function (texture, normal, lightSet, hero) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        switch (t) {
            case 0:
                m = new DarkCreeper(x, y, v, r, t, texture, normal, lightSet, w, h, hero);
                break;
            case 1:
                m = new FishSeeker(x, y, v, r, t, texture, normal, lightSet, w, h, hero);
                break;
            case 2:
                m = new ChaserMinion(x, y, v, r, t, texture, normal, lightSet, w, h, hero);
                break;
        }
...
SceneFileParser.prototype.parseWall = function (texture, normal, lightSet) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        w = new Wall(x, y, texture, normal, lightSet, t);
...
SceneFileParser.prototype.parseTrees = function (texture, lightSet) {
