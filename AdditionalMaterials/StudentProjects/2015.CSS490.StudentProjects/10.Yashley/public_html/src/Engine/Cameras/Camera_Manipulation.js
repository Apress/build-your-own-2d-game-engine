...
/*
Camera.prototype.update = function (cameraBounds) {
    if (this.mCameraShake !== null) {
        if (this.mCameraShake.shakeDone()) {
            this.mCameraShake = null;
        } else {
    ...
    var newCenter = this.getWCCenter(); 
    var curCenter = this.mCameraState.getCenter(); 
 
    if (curCenter[0] + this.getWCWidth()/2 > cameraBounds[1]) {
        newCenter[0] = cameraBounds[1] - this.getWCWidth()/2; 
    }
    if (curCenter[0] - this.getWCWidth()/2 < cameraBounds[0]) {
        newCenter[0] = cameraBounds[0] + this.getWCWidth()/2; 
    }
    if (curCenter[1] + this.getWCHeight()/2 > cameraBounds[3]) {
        newCenter[1] = cameraBounds[3] - this.getWCHeight()/2; 
    }
    if (curCenter[1] - this.getWCHeight()/2 < cameraBounds[2]) {
        newCenter[1] = cameraBounds[2] + this.getWCHeight()/2; 
    }
