...
GameObject.prototype.intersectBounds = function (otherBound) {
    var thisXform = this.getXform(); 
    var thisBoundBox = this.getBBox(); 
   // var otherXform = otherBound.getGroupTrans(); 
    var otherBBox = otherBound.getBBox(); 
      
   return ( (this.minX() * thisXform.getWidth() + thisXform.getXPos() < otherBBox.maxX()) && 
            (this.maxX() * thisXform.getWidth() + thisXform.getXPos() > otherBBox.minX())) &&
            (this.minY() * thisXform.getHeight() + thisXform.getYPos() < otherBBox.maxY() ) &&
            (this.maxY() * thisXform.getHeight() + thisXform.getYPos() > otherBBox.minY() );
    
};

GameObject.prototype.minX = function () {
    return this.getXform().getXPos() - this.getXform().getWidth()/2; 
}; 

GameObject.prototype.minY = function () {
    return this.getXform().getYPos() - this.getXform().getHeight()/2; 
}; 
