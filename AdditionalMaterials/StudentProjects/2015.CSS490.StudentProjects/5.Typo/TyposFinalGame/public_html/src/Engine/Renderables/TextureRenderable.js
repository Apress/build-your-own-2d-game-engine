...
// Added so that texture renderable has a drawchild func to take in groupTransform
TextureRenderable.prototype.drawAsChild = function (aCamera, groupTransform) {
    gEngine.Textures.activateTexture(this.mTexture);
    Renderable.prototype.drawAsChild.call(this, aCamera, groupTransform);
};
