 ...
 * Description:		Encapsulates the user define WC and Viewport functionality
 */
...
Camera.prototype.setWCCurrentCenter = function (xPos, yPos) {
    var p = vec2.fromValues(xPos, yPos);
    this.mCameraState.setCurrentCenter(p);
};
