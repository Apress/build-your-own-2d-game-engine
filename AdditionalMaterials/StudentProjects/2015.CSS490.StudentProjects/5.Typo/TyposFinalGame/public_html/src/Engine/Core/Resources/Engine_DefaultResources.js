...
gEngine.DefaultResources = (function () {
    ...
    var kBoundTexture = "assets/Bound.png";
    var getBoundTexture = function() { return kBoundTexture; };
    ...
    var initialize = function (callBackFunction) {
        ...
        gEngine.Textures.loadTexture(kBoundTexture);
    ...
    var cleanUp = function () {
        ...
        gEngine.Textures.unloadTexture(kBoundTexture);
    };
    ...
    var mPublic = {
        ...
        cleanUp: cleanUp,
        getBoundTexture: getBoundTexture
    };
    return mPublic;
}());