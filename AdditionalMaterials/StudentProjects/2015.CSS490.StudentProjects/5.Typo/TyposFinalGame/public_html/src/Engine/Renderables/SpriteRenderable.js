...
// Added draw as child function so sprite renderables have group transform
SpriteRenderable.prototype.drawAsChild = function (aCamera, groupTransform) {
    this.mShader.setTextureCoordinate(this.getElementUVCoordinateArray());
    TextureRenderable.prototype.drawAsChild.call(this, aCamera, groupTransform);
};
