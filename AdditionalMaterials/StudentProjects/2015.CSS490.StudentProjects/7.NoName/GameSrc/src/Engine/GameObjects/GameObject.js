...
GameObject.prototype.rotateObjPointToDir = function (dir, rate) {
...
GameObject.prototype.addLight = function (lgt) {
    this.mRenderComponent.addLight(lgt);
};

GameObject.prototype.removeLight = function (lgt) {
    this.mRenderComponent.removeLight(lgt);
};