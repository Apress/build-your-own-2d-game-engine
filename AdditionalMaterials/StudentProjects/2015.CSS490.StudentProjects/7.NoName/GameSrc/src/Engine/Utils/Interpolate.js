...
Interpolate.prototype.isFinished = function () { return this.mCyclesLeft === 0; };
...
Interpolate.prototype.setCurrentValue = function (v) {
    this.mCurrentValue = this.mFinalValue = v;
    this.mCyclesLeft = 0;
};
