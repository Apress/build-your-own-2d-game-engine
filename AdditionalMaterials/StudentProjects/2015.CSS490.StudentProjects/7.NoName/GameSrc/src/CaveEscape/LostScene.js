...
gEngine.Core.inheritPrototype(LostScene, Scene);

LostScene.prototype.initialize = function () {
    ...
    this.mMsg = new FontRenderable("You lost!");
...
LostScene.prototype.draw = function () {
...
LostScene.prototype.update = function () {
    this.mCamera.update();
...
LostScene.prototype.loadScene = function () {
...
LostScene.prototype.unloadScene = function() {
