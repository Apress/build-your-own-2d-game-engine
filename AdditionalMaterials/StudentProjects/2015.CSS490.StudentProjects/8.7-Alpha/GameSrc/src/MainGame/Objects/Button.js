...
function Button(atX,atY, resource) {
...
gEngine.Core.inheritPrototype(Button, GameObjectSet);

Button.prototype.getButtonObj = function() { return this.mSet[0]; };

Button.prototype.hasBeenClicked = function () {
