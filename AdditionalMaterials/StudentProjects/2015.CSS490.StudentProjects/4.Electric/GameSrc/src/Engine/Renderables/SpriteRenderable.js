...
SpriteRenderable.prototype.setElementPixelPosArray = function (pos) {
    var imageW = this.mTextureInfo.mWidth;
    var imageH = this.mTextureInfo.mHeight;

    this.mTexLeft = pos[0] / imageW;
    this.mTexRight = pos[1] / imageW;
    this.mTexBottom = pos[2] / imageH;
    this.mTexTop = pos[3] / imageH;
    this._setTexInfo();
};
