...
MyGame.prototype.LevelBlock8 = function (offset) {
...
//                                                
    ...
    this.mPlatformFactory.newSpikePlatform([XLayerPos[7],YLayerPos[3]]);
    this.mPlatformFactory.newSpikePlatform([XLayerPos[8],YLayerPos[3]]);
    
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[9],YLayerPos[4]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[3]]);
     this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[9],YLayerPos[3]]);                                               
                                                
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[2]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[7],YLayerPos[2]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[8],YLayerPos[2]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[9],YLayerPos[2]]);                                                
