...
//            [50 + offset, 60], // initial position
//            20);                // detection range
//    this.mBats.addToSet(e1);
    
    var e2 = new Enemy(this.kSpriteSheetEnemy);
    e2.setHeroObject(this.mHero);
    e2.setChaseState(           // set enemy as bat
            [115 + offset, 75], // initial position
            20);                // detection range
    this.mBats.addToSet(e2);
    
//    var e = new Enemy(this.kSpriteSheetEnemy);
//    e.setHeroObject(this.mHero);
//    e.setChaseState(            // set enemy as bat
//            [130 + offset, 95],  // initial position
//            20);                // detection range
