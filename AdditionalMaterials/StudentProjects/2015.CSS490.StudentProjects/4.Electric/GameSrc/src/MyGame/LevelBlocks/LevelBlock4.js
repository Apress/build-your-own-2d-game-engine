...
MyGame.prototype.LevelBlock4 = function (offset) {
...
//                                                [XLayerPos[9],YLayerPos[3]]);
    ...
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[7]]);
                                                
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[8]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[9]]);
                                                
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[6],YLayerPos[10]]); 
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[5],YLayerPos[9]]);
                                                
    this.mPlatformFactory.newSpikePlatform([XLayerPos[5],YLayerPos[10]]);                                            
...
//                                                [XLayerPos[2],YLayerPos[11]]);
    ...
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[2],YLayerPos[8]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[2],YLayerPos[7]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[2],YLayerPos[6]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[3],YLayerPos[6]]);
                                                
    this.mPlatformFactory.newAwardPlatform([XLayerPos[7],YLayerPos[6]]);
    
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[8],YLayerPos[6]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[9],YLayerPos[6]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[10],YLayerPos[6]]);
    this.mPlatformFactory.newSimplePlatform('stone','objects',
                                                [XLayerPos[11],YLayerPos[6]]);    
...
//            [120 + offset, 60],  // initial position
//            5,                 // pace distance
//            30);                // detection range
//    this.mBlobs.addToSet(e);
   ...
   var e = new Enemy(this.kSpriteSheetEnemy);
    e.setHeroObject(this.mHero);
    e.setPaceState(             // set enemy as "not bat"
            [120 + offset, 100],  // initial position
            5,                 // pace distance
            30);                // detection range
    this.mBlobs.addToSet(e);
//    
