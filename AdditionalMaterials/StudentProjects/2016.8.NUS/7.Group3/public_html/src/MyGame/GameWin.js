...
function GameWin(level) {
    ...
    //this.kWinClip="assets/over.mp3";
    this.mCamera = null;
    this.myfont = "assets/Consolas-32";
   
    this.kTitle = "assets/wintitle.png";
...
GameWin.prototype.initialize = function () {
    gEngine.AudioClips.playACue(this.kWinClip);
    // Initialize Lights
    ...
    this.hint = new FontRenderable("input name or click menu");
    ...
    this.mSubmitButton = new Button(this.kSubmit, null, [28, 20], [14, 5], this.mLight);
    this.mSubmitButton.setVisibility(false);
    
    this.mMenuButton = new Button(this.kMenu, null, [53, 20], [14, 5], this.mLight);
