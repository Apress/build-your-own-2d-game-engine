...
MyGame.prototype.initialize = function () {
    ...
    this.mCamera.setBackgroundColor([0.3, 0.7, 0.7, 0]);
...
MyGame.prototype.draw = function () {
    ...
    gEngine.Core.clearCanvas([0.9, 0.9, 0.9, 0.0]); // clear to light gray
...
MyGame.prototype.update = function () {
    ...
    this.mMsg2.setText("The Goal is Score reach 50!");
