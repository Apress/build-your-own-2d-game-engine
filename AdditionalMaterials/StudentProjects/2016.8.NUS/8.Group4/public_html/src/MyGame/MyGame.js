...
MyGame.prototype.initialize = function () {    
   this.mCamera = new Camera(
    ...
    this.mLevel = new FontRenderable("Level 1");
    ...
    this.mGunName = new FontRenderable("Enemy :  "+ this.countEnemy+"/10");
    this.mGunName.setColor([0, 0, 0, 1]);
    this.mGunName.getXform().setPosition(25, 108);
    this.mGunName.getXform().setSize(12,5);
    
    this.mGunName2 = new FontRenderable("SuperEnemy :  "+this.countSuperEnemy+"/5");
...
MyGame.prototype.update = function () {
    ...
    this.mGunName.setText("Enemy :  "+ this.countEnemy+"/10");
    this.mGunName2.setText("SuperEnemy :  "+ this.countSuperEnemy+"/5");
    this.mHero.update();
    this.mCamera.update();
    ...
    for(i = 0; i<this.mBullet.length;i++){
        ...
        for(j = 0; j < this.mSuperEnemy.length; j++){
            ...
            this.mGunName2.setText("Enemy : "+ this.countSuperEnemy+"/5");
        }
        }
    }
    for(i = 0;i<this.mEnemyBullet.length;i++){
    ...
    for(i = 0; i < this.mEnemy.length; i++){
        ...
        if(t >= 3){
            ...
            if(this.mEnemy[i].getXform().getXPos() > this.mHero.getXform().getXPos() - 9 
                ...
                && this.mEnemy[i].getXform().getYPos() > this.mHero.getXform().getYPos() - 15
                && this.mEnemy[i].getXform().getYPos() < this.mHero.getXform().getYPos() + 15){
                var t = this.mEnemy[0];
    ...
    for(i = 0; i < this.mSuperEnemy.length; i++){
        ...
        if(t >= 3){
            ...
            if(this.mSuperEnemy[i].getXform().getXPos() > this.mHero.getXform().getXPos() - 9 
                ...
                && this.mSuperEnemy[i].getXform().getYPos() > this.mHero.getXform().getYPos() - 18
                && this.mSuperEnemy[i].getXform().getYPos() < this.mHero.getXform().getYPos() + 18){
   ...
   xform = this.mHero.getXform();
    if (gEngine.Input.isKeyClicked(gEngine.Input.keys.J)) {
        ...
        //if(this.mBullet.getXform().getXPos()>10)
        //this.mBullet.shift();
  ...
  /* if(xform.getXPos() - this.pastZ > 160 || this.pastZ - xform.getXPos() > 160){
    ...
    /*if(xform.getXPos() - this.pastY > 150 || this.pastY - xform.getXPos() > 150){
        xform.setXPos(this.pastW);
    }*/
   ...
   var v = Math.floor(Math.random()*24);
    ...
    if(this.countEnemy >= 10 && this.countSuperEnemy >= 5){
