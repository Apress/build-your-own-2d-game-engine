...
function NightLevel(level, iniScore, aChance) {
    this.mCamera = null;
    ...
    this.mBgTexture = "assets/night_bg.png";
    //this.mFgTexture = "assets/FeedMe_bg_bush_up.png";
    this.mFgTexture4 = "assets/night_bush.png";
    this.mFgTexture2 = "assets/night_pad_light.png";
    this.mFgTexture3 = "assets/night_pad.png";
    this.mFishTexture = "assets/night_fish.png";
    this.mFoodTexture = "assets/Food.png";
    this.mShadowFishTexture = "assets/shadowFish.png";

    this.kBgMusic = "assets/end.mp3";
...
gEngine.Core.inheritPrototype(NightLevel, Scene);

NightLevel.prototype.loadScene = function () {
...
NightLevel.prototype.unloadScene = function () {
    ...
    if(this.mGameOver){
        ...
        if(this.nextLevelNum === 0){
            var nextLevel = new NightLevel(this.mLevel+this.nextLevelNum, this.mNextScore, false);
            gEngine.Core.startScene(nextLevel);
        }
        else{
...
NightLevel.prototype._initializeLight = function(){
    gEngine.DefaultResources.setGlobalAmbientIntensity(1.5);
};


NightLevel.prototype._initializeForeground = function(){
...
NightLevel.prototype.initialize = function () {
    ...
    this.mLightFishSet.addFishes(1);
    this.mLightArray = this.mLightFishSet.getLightSet();
    
    this.mPlayer = new NightPlayer(this.mCamera, this.mFoodTexture, 
                            this.mLevel, this.kFontCon72, this.mNextScore, this.mChance);
    this.mPlayer.initialize();
    this.mMainLight = this.mPlayer.getLight();
    this.mLightArray.push(this.mMainLight);
...
NightLevel.prototype._drawForeground = function(myCamera){
...
NightLevel.prototype.draw = function () {
...
NightLevel.prototype.update = function () {
