...
function ShadowFish(x, y, aCamera, aTexture) {
    // The camera to view the scene
    //this.mSpeed = 0.1;   // 0.8 is properly.
    this.mCamera = aCamera;

    this.mFish = new TextureRenderable(aTexture);
...
gEngine.Core.inheritPrototype(ShadowFish, Fish);


ShadowFish.prototype.initialize = function(){
...
ShadowFish.prototype._getRandomPosition = function(){
...
ShadowFish.prototype._patrol = function(){
...
ShadowFish.prototype.update = function(){
