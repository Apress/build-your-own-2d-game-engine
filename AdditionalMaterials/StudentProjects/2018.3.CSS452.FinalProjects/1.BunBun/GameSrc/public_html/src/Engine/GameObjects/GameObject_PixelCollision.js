...
GameObject.prototype.pixelTouches = function (otherObj, wcTouchPos) {
    ...
    if ((typeof myRen.pixelTouches === "function") && (typeof otherRen.pixelTouches === "function")) {
        if ((myRen.getTransform().getRotationInRad() === 0) && (otherRen.getTransform().getRotationInRad() === 0)) {
            ...
            var mySize = myRen.getTransform().getSize();
            var otherSize = otherRen.getTransform().getSize();
            ...
            var d = [];
            vec2.sub(d, myRen.getTransform().getPosition(), otherRen.getTransform().getPosition());
