...
ShadowReceiver.prototype.removeShadowCaster = function (casterObj) {
    var index = -1;
    for(var i = 0; i < this.mShadowCaster.length; ++i)
    {
        if(this.mShadowCaster[i].mShadowCaster === casterObj)
            index = i;
    }
    if(index !== -1)
    {
