 ...
 * @class Dust
 */
function Dust(DustParams){//b,xPos, yPos, width, yAcceleration, life, xVelocity, yVelocity, flicker, intensity, xAcceleration, size, yOffset){
    this.Begin = DustParams.b;
 ...
 * @type struct
 */
DustParams = function(b,xPos, yPos, width, yAcceleration, life, xVelocity, yVelocity, flicker, intensity, xAcceleration, size, yOffset){
    this.Begin = b;
    this.xPos=xPos||50;
    this.yPos=yPos||50;
    this.width=width||50;
