...
function bullet(init_position, direct_x, speed, bullet_length, lethality)
{
    ...
    this.mbullet.getXform().setPosition(init_position.mPosition[0], init_position.mPosition[1]+9);
    if(direct_x % 2 === 1)
