...
bullet_lib.prototype.fire = function(){
    switch(this.status)
    {
        case 0:
            this.bullet_count_max = 1;
            if(this.bullet_count < this.bullet_count_max && this.frame >= 80)
            {
                ...
                this.bullet[this.bullet_count] = new bullet(this.position, this.direct, 16, 30, 40);
                this.bullet_count++;
            }
            break;
        case 1:
            ...
            if(this.bullet_count < this.bullet_count_max && this.frame >= 25)
            {
                ...
                this.bullet[this.bullet_count] = new bullet(this.position, this.direct, 8, 20, 20);
                this.bullet_count++;
            }
            break;
        case 2:
        ...
        case 8:
            ...
            if(this.bullet_count < this.bullet_count_max && this.frame >= 40)
            {
                ...
                this.frame = 0;
                gEngine.AudioClips.playACue(this.gun_wav);
                this.bullet[this.bullet_count] = new bullet(this.position, this.direct, 8, 20, 25);
                this.bullet_count++;
            }
            break;
    }
