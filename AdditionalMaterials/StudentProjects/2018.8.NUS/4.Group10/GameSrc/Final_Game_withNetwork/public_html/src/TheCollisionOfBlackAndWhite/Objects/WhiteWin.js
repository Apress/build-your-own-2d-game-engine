...
function WhiteWin(){
    this.kBg="assets/WhiteWin.png";
    
    this.mBg = null;
}
gEngine.Core.inheritPrototype(WhiteWin, Scene);

WhiteWin.prototype.loadScene = function () {
    gEngine.Textures.loadTexture(this.kBg);
};

WhiteWin.prototype.initialize = function () {
...
WhiteWin.prototype.draw = function () {
...
WhiteWin.prototype.update = function(){
    if (gEngine.Input.isKeyClicked(gEngine.Input.keys.Esc)){
        gEngine.GameLoop.stop();
    }
};

WhiteWin.prototype.unloadScene = function() {
