...
function BlackWin(){
    this.kBg="assets/BlackWin.png";
    
    this.mBg = null;
}
gEngine.Core.inheritPrototype(BlackWin, Scene);

BlackWin.prototype.loadScene = function () {
    gEngine.Textures.loadTexture(this.kBg);
};

BlackWin.prototype.initialize = function () {
...
BlackWin.prototype.draw = function () {
...
BlackWin.prototype.update = function(){
    if (gEngine.Input.isKeyClicked(gEngine.Input.keys.Esc)){
        gEngine.GameLoop.stop();
    }
};

BlackWin.prototype.unloadScene = function() {
