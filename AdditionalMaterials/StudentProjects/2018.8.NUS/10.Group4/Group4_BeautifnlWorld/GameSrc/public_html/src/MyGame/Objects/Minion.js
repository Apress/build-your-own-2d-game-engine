...
function Minion(spriteTexture, atX, atY, createCircle, w, h) {
...
//    var h = kMinionHeight + Math.random() * kMinionRandomSize;
    ...
    this.mMinion.setSpriteSequence(190, 0,      // first element pixel position: top-left 512 is top of image, 0 is left of image
                                    30, 30,   // widthxheight in pixels
...
Minion.prototype.update = function (aCamera) {
    ...
    this.mMinion.getXform().incYPosBy(-30);
