...
ParticleGameObject.prototype.incVelocity = function (delta) {
    var curSpeed = Math.max(this.getVelocity()+delta,0);
    vec2.scale(this.mParticle.mVelocity, this.mCurrentFrontDir ,curSpeed);
};

ParticleGameObject.prototype.getVelocity = function () {
    return vec2.length(this.mParticle.mVelocity);
};

ParticleGameObject.prototype.setVelocity = function (Speed) {
    vec2.scale(this.mParticle.mVelocity,this.mCurrentFrontDir,Speed);
};