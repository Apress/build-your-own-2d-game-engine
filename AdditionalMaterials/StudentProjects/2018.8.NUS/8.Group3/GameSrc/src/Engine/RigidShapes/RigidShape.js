...
RigidShape.prototype.incVelocityByValue = function (direct,deltaV) {
    vec2.scaleAndAdd(this.mVelocity,this.mVelocity,direct,deltaV);
};
RigidShape.prototype.getVelocityByValue = function(){
    return vec2.length(this.mVelocity);
};
RigidShape.prototype.setVelocityByValue = function(direct,V) {
    vec2.scale(this.mVelocity,direct,V);
};
