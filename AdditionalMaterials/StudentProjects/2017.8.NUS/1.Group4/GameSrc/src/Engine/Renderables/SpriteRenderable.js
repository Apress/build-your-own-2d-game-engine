...
SpriteRenderable.prototype.getTextureWidth = function () {
    var texInfo = gEngine.ResourceMap.retrieveAsset(this.mTexture);
    var texWidth = texInfo.mWidth;
    return texWidth;
};

SpriteRenderable.prototype.getTextureHeight = function () {
    var texInfo = gEngine.ResourceMap.retrieveAsset(this.mTexture);
    var texHeight = texInfo.mHeight;
    return texHeight;
};
