...
/*global gEngine, MyGame, Light, LightSet, NightMyGame */
...
NightMyGame.prototype._createALight = function (type, pos, dir, color, n, f, inner, outer, intensity, dropOff) {
    var light = new Light();
    light.setLightType(type);
    light.setColor(color);
    light.setXPos(pos[0]);
...
NightMyGame.prototype._initializeLights = function () {
    this.mGlobalLightSet = new LightSet();

    var l = this._createALight(Light.eLightType.ePointLight,
            [-40, -22, 10],         // position
            [0, 0, -1],          // Direction 
            [1.0, 1.0, 1.0, 0],  // some color
            20, 40,               // near and far distances
            0.1, 0.2,            // inner and outer cones
            5,                   // intensity
            1.0                  // drop off
