...
function NightMerchant(spriteTexture) {
  ...
  //  this.kDeltaRad = Math.PI * this.kDeltaDegree / 180;
    ...
    this.mMerchant = new LightRenderable(spriteTexture);
...
gEngine.Core.inheritPrototype(NightMerchant, GameObject);

NightMerchant.prototype.update = function (Timer,mBullet,thelight) {
...
NightMerchant.prototype.IsAttack = function(){
    return this.isAttack;
};
NightMerchant.prototype.ChangeIsAttack = function(i){
  this.isAttack = i;
};

NightMerchant.prototype.fire = function (mBullet,thelight) {
   var merBullet = new NightBullet(this.kBullet, this.mMerchant.getXform().getXPos(), this.mMerchant.getXform().getYPos() - 10, 1);
   merBullet.getRenderable().addLight(thelight);
   mBullet.push(merBullet);
           
};

NightMerchant.prototype.decHP = function (deltaHp) {
    this.HP -= deltaHp;
};

NightMerchant.prototype.getHP = function () {
    return this.HP;
};
