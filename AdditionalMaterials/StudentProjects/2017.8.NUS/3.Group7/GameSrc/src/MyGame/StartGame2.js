...
'use strict'
/*global gEngine*/ 
function StartGame2(player1,player2,player1Texture,player2Texture,player1WinTimes = 0, player2WinTimes = 0){
...
StartGame2.prototype.generateRandomObstacle = function(){
    let random = (min, max) => {
...
StartGame2.prototype.unloadScene = function () {
    ...
    if(this.mPlayer1WinTimes === 3){
        ...
        next = new EndScene2(this.mResult,this.kPlayer2Texture,true,this.mPlayer1Character,this.mPlayer2Character)
    }else if(this.mPlayer2WinTimes === 3){
        this.mResult = this.kPlayer2Texture
        next = new EndScene2(this.mResult,this.kPlayer1Texture,false,this.mPlayer1Character,this.mPlayer2Character)
    }else{
        next = new StartGame2(this.mPlayer1Character,this.mPlayer2Character,this.kPlayer1Texture,this.kPlayer2Texture,
...
StartGame2.prototype.draw = function(){
...
StartGame2.prototype.update = function(){
