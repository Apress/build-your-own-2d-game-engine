/*
 * File: LoopSpriteRenderable.js
 *  
 * Create by phreeze Tang 1/8/2017
 */
...
function LoopSpriteRenderable(myTexture) {
    TextureRenderable.call(this, myTexture);
    Renderable.prototype._setShader.call(this, gEngine.DefaultResources.getLoopSpriteShader());
...
gEngine.Core.inheritPrototype(LoopSpriteRenderable, TextureRenderable);
...
LoopSpriteRenderable.eTexCoordArray = Object.freeze({
    eLeft: 2,
    eRight: 0,
    eTop: 1,
    eBottom: 5
...
LoopSpriteRenderable.prototype.setElementUVCoordinate = function (left, right, bottom, top) {
    this.mTexLeft = left;
...
LoopSpriteRenderable.prototype.setElementPixelPositions = function (left, right, bottom, top) {
...
LoopSpriteRenderable.prototype.getElementUVCoordinateArray = function () {
    return [
...
LoopSpriteRenderable.prototype.draw = function (aCamera) {
...
LoopSpriteRenderable.prototype._setTexInfo = function () {
    var imageW = this.mTextureInfo.mWidth;
    var imageH = this.mTextureInfo.mHeight;
