...
gEngine.Core.inheritPrototype(Win3, Scene);

//GameOver.prototype.unloadScene = function () {
//     var nextLevel = new GameStart();  // next level to be loaded
//    gEngine.Core.startScene(nextLevel);
//};
Win3.prototype.loadScene = function () {
...
Win3.prototype.unloadScene = function () {
...
Win3.prototype.initialize = function () {
    ...
    this.mMsg1 = new FontRenderable("Next Level");
...
Win3.prototype.update = function () {
    ...
    if(this.mMsg0.getXform().getYPos()===this.mMsg1.getXform().getYPos())
    {
        this.mMsg1.setColor([0, 0, 0, 1]);
        
        if(gEngine.Input.isKeyClicked(gEngine.Input.keys.Down))
        {   this.mMsg0.getXform().setYPos(22);
            this.mMsg1.setColor([0.5, 0.5, 0.5, 1]);
    ...
    if(this.mMsg0.getXform().getYPos()===this.mMsg2.getXform().getYPos())
    {
        ...
        {   this.mMsg0.getXform().setYPos(32);
            this.mMsg2.setColor([0.5, 0.5, 0.5, 1]);
            this.mMsg1.setColor([0, 0, 0, 1]);
        }
        //start
        else if(gEngine.Input.isKeyClicked(gEngine.Input.keys.Space)){
