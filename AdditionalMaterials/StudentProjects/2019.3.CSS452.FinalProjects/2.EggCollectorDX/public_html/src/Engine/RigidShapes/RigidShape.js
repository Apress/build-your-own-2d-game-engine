...
function RigidShape(xf) {
    ...
    this.mZRotationLocked = false;
    
    this.mPhysicsEnabled = true;
}

RigidShape.prototype.setRotationLock = function(locked) { this.mZRotationLocked = locked; };
RigidShape.prototype.getRotationLock = function() { return this.mZRotationLocked; };
