...
gEngine.VertexBuffer = (function () {
    ...
    var initialize = function () {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(verticesOfBorder), gl.STATIC_DRAW);
    ...
    var getBorderVertexRef = function () {return borderVertexBuffer; };
    ...
    var mPublic = {
        ...
        getBorderVertexRef: getBorderVertexRef,
        cleanUp: cleanUp
    };
