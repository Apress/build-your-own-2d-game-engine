...
function ShakePosition(xDelta, yDelta, shakeFrequency, shakeDuration) {
    ...
    this.defaultNumCycles = this.mNumCyclesLeft;
}
...
ShakePosition.prototype.ResetShake = function(){
    
    this.mNumCyclesLeft = this.defaultNumCycles;
    
};

ShakePosition.prototype.stopShake = function(){
