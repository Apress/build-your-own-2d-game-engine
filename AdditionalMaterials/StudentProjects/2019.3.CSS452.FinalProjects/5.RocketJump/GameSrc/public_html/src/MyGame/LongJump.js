...
function LongJump() {
    this.kSceneFile = "assets/levels/LongJump.json";
...
gEngine.Core.inheritPrototype(LongJump, Scene);


LongJump.prototype.loadScene = function () {
...
LongJump.prototype.unloadScene = function () {
    ...
    if(this.LevelSelect==="Win"){
        gEngine.Core.startScene(new WinScreen(this.timeCompleted/1000, this.deaths, "LongJump Level"));
        //to precision
    }else{
...
LongJump.prototype.initialize = function () {
...
LongJump.prototype.draw = function () {
...
LongJump.kBoundDelta = 0.1;
LongJump.prototype.update = function () {
...
LongJump.prototype.backSelect = function(){
    if(this.menuEnabled){
        gEngine.GameLoop.stop();
    }
};