...
function Medium() {
    this.kSceneFile = "assets/levels/medium.json";
...
gEngine.Core.inheritPrototype(Medium, Scene);


Medium.prototype.loadScene = function () {
...
Medium.prototype.unloadScene = function () {
    ...
    if(this.LevelSelect==="Win"){
        gEngine.Core.startScene(new WinScreen(this.timeCompleted/1000, this.deaths, "Medium Level"));
        //to precision
    }else{
...
Medium.prototype.initialize = function () {
...
Medium.prototype.backSelect = function(){
    if(this.menuEnabled){
        gEngine.GameLoop.stop();
    }
};