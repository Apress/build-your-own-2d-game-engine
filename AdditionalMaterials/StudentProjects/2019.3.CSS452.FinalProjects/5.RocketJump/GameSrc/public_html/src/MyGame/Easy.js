...
function Easy() {
    this.kSceneFile = "assets/levels/easy.json";
...
gEngine.Core.inheritPrototype(Easy, Scene);


Easy.prototype.loadScene = function () {
...
Easy.prototype.unloadScene = function () {
    ...
    if(this.LevelSelect==="Win"){
        gEngine.Core.startScene(new WinScreen(this.timeCompleted/1000, this.deaths, "Easy Level"));
        //to precision
    }else{
...
Easy.prototype.initialize = function () {
...
Easy.prototype.backSelect = function(){
    if(this.menuEnabled){
        gEngine.GameLoop.stop();
    }
};