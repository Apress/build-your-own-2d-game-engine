...
function SlowMissiles() {
    this.kSceneFile = "assets/levels/SlowMissile.json";
...
gEngine.Core.inheritPrototype(SlowMissiles, Scene);


SlowMissiles.prototype.loadScene = function () {
...
SlowMissiles.prototype.unloadScene = function () {
    ...
    if(this.LevelSelect==="Win"){
        gEngine.Core.startScene(new WinScreen(this.timeCompleted/1000, this.deaths, "SlowMissiles Level"));
        //to precision
    }else{
...
SlowMissiles.prototype.initialize = function () {
...
SlowMissiles.prototype.draw = function () {
...
SlowMissiles.kBoundDelta = 0.1;
SlowMissiles.prototype.update = function () {
...
SlowMissiles.prototype.backSelect = function(){
    if(this.menuEnabled){
        gEngine.GameLoop.stop();
    }
};