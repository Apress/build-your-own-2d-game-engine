...
function VeryHard() {
    this.kSceneFile = "assets/levels/veryhard.json";
...
gEngine.Core.inheritPrototype(VeryHard, Scene);


VeryHard.prototype.loadScene = function () {
...
VeryHard.prototype.unloadScene = function () {
    ...
    if(this.LevelSelect==="Win"){
        gEngine.Core.startScene(new WinScreen(this.timeCompleted/1000, this.deaths, "VeryHard Level"));
        //to precision
    }else{
...
VeryHard.prototype.initialize = function () {
...
VeryHard.prototype.draw = function () {
...
VeryHard.kBoundDelta = 0.1;
VeryHard.prototype.update = function () {
...
VeryHard.prototype.backSelect = function(){
    if(this.menuEnabled){
        gEngine.GameLoop.stop();
    }
};