...
////this is added by Huaming
GameObject.prototype.collisionTest = function (otherObj) {
    var h = [];
    if (this.mCollisionSet == null) {
        this.mCollisionSet = new GameObjectSet();
    }
    if (this.pixelTouches(otherObj, h))
    {
        if (!this.mCollisionSet.findObject(otherObj)) {
            this.onCollisionEnter(otherObj);
            this.mCollisionSet.addToSet(otherObj)
            if (otherObj.mCollidableFlag) {
                if (otherObj.mCollisionSet == null) {
                    otherObj.mCollisionSet = new GameObjectSet();
                }
                otherObj.mCollisionSet.addToSet(this);
                otherObj.onCollisionEnter(this);
            }
        }
        this.onCollisionStay(otherObj);
        if (otherObj.mCollidableFlag) {
            otherObj.onCollisionStay(this);
        }
    }
    else {
        if (this.mCollisionSet.findObject(otherObj))
...
GameObject.prototype.collisionExitTest = function () {
    var i;
    var h = [];
    if (this.mCollisionSet == null) {
        this.mCollisionSet = new GameObjectSet();
...
GameObject.prototype.onCollisionStay = function (otherObj) {

};
GameObject.prototype.onCollisionEnter = function (otherObj) {
